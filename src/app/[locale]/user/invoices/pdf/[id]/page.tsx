  ...
  return (
    ...
    <>
      ...
      <div className="bg-white rounded-xl border-gray border mt-10   " ref={invoiceRef}>
        ...
        <h1 className="mt-[-30px]  text-center text-blue font-bold text-xl">{order?.status}</h1>
          ...
          <div>
            <div className="mt-4">
              ...
              <table className="w-full border-collapse border border-b-gray">
                <thead>
                  <tr>
                    <th className="text-xs lg:text-sm py-1 px-2 col-span-2 text-left">Items</th>
                    <th className="text-xs lg:text-sm py-1 px-2 text-left">Quantity</th>
                    <th className="text-xs lg:text-sm py-1 px-2 text-left">Price</th>
                    <th className="text-xs lg:text-sm py-1 px-2 text-right col-span-2">Amount</th>
                  </tr>
                </thead>
                <tbody>
                  <tr>
                  ...
                  <tr>
                    <td className="text-xs lg:text-sm py-1 px-2"><span className="font-semibold">Flexi Plan Service Charge</span> <br/>
                      <span>Exemption for over N100,000 print</span></td>
                  ...
                  <tr>
                    <td className="text-xs lg:text-sm py-1 px-2"><span className="font-semibold">Book covr embossing</span> <br/>
                      <span>Cover embossing for {order?.book?.title} (100 copies)</span></td>
                    <td className="text-xs lg:text-sm py-1 px-2 col-span-2 text-left">0.00</td>
                    <td className="text-xs lg:text-sm py-1 px-2 text-left col-span-2">0.00</td>
                    <td className="text-xs lg:text-sm py-1 px-2 text-right`~~~~ col-span-2">0.00</td>
                  </tr>
