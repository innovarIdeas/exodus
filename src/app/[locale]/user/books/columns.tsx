...
export const columns: ColumnDef<IBook>[] = [
  ...
  },
  {
    ...
    cell: ({ row }) => {
      ...
      return (
        <Link  href={`/user/books/${book.id}`} ><button className="rounded-sm h-[40px] w-fit bg-main text-white text-x flex items-center justify-center gap-2 cursor-pointer px-4 shadow-lg hover:shadow-none">View</button></Link>
      );
    },
  },
];
