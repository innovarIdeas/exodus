...
const page = () => {
    ...
    const {readyToPrint, setName, setPhoneNumber, setEmail, setBookName, setReadyToPrint, setBook, setMagazine, setStationary, setWorkInProgress, workInProgress, book, stationary, magazine } = contextValues;
  ...
  const onSubmit: SubmitHandler<FormData> = async (step0Data) =>{ 
    ...
    const myData = {
      ...step0Data, status:"active", project_type: projectType, ready_to_print: readyToPrint, work_in_progress: workInProgress}
