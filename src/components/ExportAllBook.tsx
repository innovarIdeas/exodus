...
import { exportAllBooks } from "@/lib/api-call";
...
const ExportAllBook = () => {
  ...
  const onSubmit = async () => {
    setIsLoading(true);
    const { data, error, validationErrors } = await exportAllBooks();
    ...
    if (data) {
      ...
      XLSX.utils.book_append_sheet(workbook, sheet, "exodus-books");
      ...
      link.href = url;
      link.download = "exodus_books.xlsx";
      link.click();
