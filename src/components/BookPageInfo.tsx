    ...
    <div>
      <div>
        ...
        <div className="flex flex-col gap-1 text-gray-600 my-7">
          <label htmlFor="no_of_page" className="">Number of Pages</label>
          ...
          <div className="w-[100%] overflow-x-scroll bg-blue-100">
            {potrait ?
              <div className="bg-blue-100 flex items-end  w-[120%] h-[220px] gap-5 pb-10 px-5">
                ...
                <div onClick={()=>setBookSize("A5")} className={`w-[60%] relative bg-white shadow h-[30%] hover:shadow-xl ${bookSize == "A6" && potrait ? "border-2 border-blue-400" : ""} cursor-pointer`}>
              ...
              <div className="bg-blue-100 flex w-[120%] h-[220px] gap-5 pb-10  items-end px-5">
                ...
                <div onClick={()=>setBookSize("A4")} className={`w-[90%] relative bg-white shadow h-[35%]  hover:shadow-xl ${bookSize == "5.5x8.5" ? "border-2 border-blue-400" : ""} cursor-pointer`}>
                  <h1 className="absolute left-0 top-[-5%]">5.5x8.5 </h1>
                  <div className="w-0.5 h-full absolute top-0 left-[50%] border-l border-l-gray"></div>
                </div>
                <div onClick={()=>setBookSize("A4")} className={`w-[100%] relative bg-white shadow h-[40%]  hover:shadow-xl ${bookSize == "6x9" ? "border-2 border-blue-400" : ""} cursor-pointer`}>
                  <h1 className="absolute left-0 top-[-5%]">6x9</h1>
                  <div className="w-0.5 h-full absolute top-0 left-[50%] border-l border-l-gray"></div>
                </div>
                <div onClick={()=>setBookSize("A4")} className={`w-[110%] relative bg-white shadow h-[45%]  hover:shadow-xl ${bookSize == "7x10" ? "border-2 border-blue-400" : ""} cursor-pointer`}>
                  <h1 className="absolute left-0 top-[-5%]">7x10</h1>
                  <div className="w-0.5 h-full absolute top-0 left-[50%] border-l border-l-gray"></div>
                </div>
