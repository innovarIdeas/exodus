...
import { exportAllUsers } from "@/lib/api-call";
...
const ExportAllUsers = () => {
  ...
  const onSubmit = async () => {
    setIsLoading(true);
    const { data, error, validationErrors } = await exportAllUsers();
    ...
    if (data) {
      ...
      XLSX.utils.book_append_sheet(workbook, sheet, "exodus-users");
      ...
      link.href = url;
      link.download = "exodus_users.xlsx";
      link.click();
