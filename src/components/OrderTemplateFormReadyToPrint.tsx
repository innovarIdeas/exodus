...
const OrderTemplateFormReadyToPrint = (props: Props) => {
              ...
              render={({ field }) => (
                <FormItem className="w-full">
                  ...
                  <Select onValueChange={field.onChange} value={field.value}>
                    ...
                    <SelectContent>
                      <SelectItem key={props.data.id} value={props.data.id}>{props.data.title}</SelectItem>
                    </SelectContent>
                  </Select>
                </FormItem>
              )}
...
export default OrderTemplateFormReadyToPrint;
